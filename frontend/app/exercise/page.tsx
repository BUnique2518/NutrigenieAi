...
import { Play, AlertCircle, Lightbulb, Target, ArrowLeft } from "lucide-react";
//import { exercisesDatabase, type ExerciseDetail } from "@/data/exercises";
...
const exercisesDatabase: Record<string, ExerciseDetail> = {
  "chest-1": {
    id: "chest-1",
...
export default function ExerciseDetailPage() {
  ...
  useEffect(() => {
    if (exerciseId) {
      const foundExercise = exercisesDatabase[exerciseId];
      if (foundExercise) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow">
            <h2 className="text-4xl font-bold text-gray-900 mb-2">{exercise.name}</h2>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <span className={`px-3 py-1 rounded-full text-sm font-medium ${getDifficultyBadgeColor(exercise.difficulty)}`}>
                {exercise.difficulty}
              </span>
            </div>
          </div>
          ...
          {/* Demo Video Section */}
          <div className="bg-white p-6 rounded-2xl shadow">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Demo Video</h3>
            <div className="relative bg-gray-900 rounded-xl overflow-hidden aspect-video flex items-center justify-center">
              ...
              <button className="relative z-10 w-20 h-20 bg-blue-600 hover:bg-blue-700 text-white rounded-full flex items-center justify-center transition">
                <Play size={32} fill="white" />
              </button>
              <p className="absolute bottom-4 left-4 text-white text-sm">Duration: {exercise.demoVideoLength}</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="p-3 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200">
                ...
                <p className="text-2xl font-bold text-blue-600">{exercise.quickStats.duration.split("/")[0]}</p>
                <p className="text-xs text-gray-500">/set</p>
              </div>

              <div className="p-3 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200">
                <p className="text-xs text-gray-600 font-medium mb-1">Sets</p>
                <p className="text-2xl font-bold text-green-600">{exercise.quickStats.sets.split(" ")[0]}</p>
                <p className="text-xs text-gray-500">recommended</p>
              </div>

              <div className="p-3 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200">
                <p className="text-xs text-gray-600 font-medium mb-1">Repetitions</p>
                <p className="text-2xl font-bold text-purple-600">{exercise.quickStats.reps}</p>
              ...
              <div className="p-3 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200">
                ...
                <p className="text-2xl font-bold text-orange-600">{exercise.quickStats.rest.split("-")[0]}</p>
          ...
          <div className="bg-white p-6 rounded-2xl shadow">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-gray-900">Target Muscle Groups</h3>
            </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow">
            ...
            <div className="space-y-4">
              {exercise.instructions.map((instruction) => (
                <div key={instruction.step} className="p-4 border-l-4 border-blue-600 bg-blue-50 rounded">
          ...
          <div className="bg-white p-6 rounded-2xl shadow">
            ...
            <div className="space-y-3">
              {exercise.commonMistakes.map((mistake, idx) => (
                <div key={idx} className="p-4 border-l-4 border-red-600 bg-red-50 rounded">
                  <h4 className="font-semibold text-gray-900 mb-1">❌ {mistake.title}</h4>
          ...
          <div className="bg-white p-6 rounded-2xl shadow">
            <div className="flex items-center gap-2 mb-4">
              <h3 className="text-2xl font-semibold text-gray-900">Breathing Technique</h3>
            </div>
            <div className="space-y-4">
              <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
                <h4 className="font-semibold text-gray-900 mb-2">🫁 Optimal Breathing Pattern</h4>
                <ol className="text-sm text-gray-700 space-y-2 list-decimal pl-5">
                  {exercise.breathing.pattern.map((step, idx) => (
                    <li key={idx}>{step}</li>
                  ))}
                </ol>
              </div>
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <ul className="text-sm text-gray-700 space-y-1 list-disc pl-5">
                  {exercise.breathing.importance.map((reason, idx) => (
          ...
          <div className="bg-white p-6 rounded-2xl shadow">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-gray-900">Pro Tips & Variations</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow sticky top-10">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-xs text-gray-600 font-medium uppercase block mb-2">Equipment</label>
                <div className="w-full p-2 border rounded-lg text-gray-900 font-semibold bg-gray-50">
                  {exercise.equipment}
                </div>
              </div>
              ...
              <div>
                <label className="text-xs text-gray-600 font-medium uppercase block mb-2">Exercise Type</label>
                <div className="w-full p-2 border rounded-lg text-gray-900 font-semibold bg-gray-50">
                  {exercise.exerciseType}
                </div>
              </div>
              ...
              <div>
                <label className="text-xs text-gray-600 font-medium uppercase block mb-2">Experience Level</label>
                <div className="w-full p-2 border rounded-lg text-gray-900 font-semibold bg-gray-50">
            ...
            <button
              onClick={() => router.back()}
              className="w-full mt-3 py-3 bg-gray-200 hover:bg-gray-300 text-gray-900 rounded-lg font-semibold transition"
            >
              Back to Plan
            </button>
          </div>
